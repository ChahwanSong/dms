  ...
  return (
    <div className="inventory">
      ...
      <VirtualRows
        ...
        header={
          <div className="vrow vgrid-sc vhead">
            ...
            <div className="vcell">경로 (path)</div>
        ...
        itemContent={(_i, j) => {
          ...
          return (
            <div className={`vitem${isOpen ? " open" : ""}`}>
              <div
                className={`vrow vgrid-sc${expandable ? " expandable" : ""}${isOpen ? " row-open" : ""}`}
              ...
              >
                ...
                <div className="vcell muted small" data-label="결과">
                  {j.result

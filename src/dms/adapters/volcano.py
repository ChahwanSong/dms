    ...
    def volcano_job_metrics(
        ...
        for it in vcjobs[:limit]:
            ...
            jobs_out.append({
                ...
                "phase_kind": labels.get("dms.openai.com/data-phase"),
                "request_id": labels.get("dms.openai.com/request-id"),
                "data_job_id": labels.get("dms.openai.com/data-job-id"),
                # job owner's resolved POSIX identity (the "requester" on the card).
                "requester": _pod_env(jpods, "DMS_POSIX_USERNAME"),
                ...
                # scan / rm target (None for sync jobs and vice-versa)
                "scan_storage": _pod_env(jpods, "DMS_SCAN_STORAGE"),
                "scan_path": _pod_env(jpods, "DMS_SCAN_PATH"),
                "rm_storage": _pod_env(jpods, "DMS_RM_STORAGE"),
                "rm_path": _pod_env(jpods, "DMS_RM_TARGET_PATH"),

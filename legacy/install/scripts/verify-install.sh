...
check "data scan job 확인" "/api/v1/operations/data-jobs?operation=data.scan&limit=5"
check "data sync job 확인" "/api/v1/operations/data-jobs?operation=data.sync&limit=5"
check "data rm job 확인" "/api/v1/operations/data-jobs?operation=data.rm&limit=5"

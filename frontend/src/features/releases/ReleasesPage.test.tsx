...
const TARGETS = {
  ...
  targets: [
    ...
    { component: "job-image", kind: "ConfigOverride", workload: "control_state",
      container: "-", repository: "dms-mpifileutils",
      current_image: "pkg-01:5000/dms-mpifileutils:d53", tags: ["d53", "d80"] },

...
python3 -m pytest -q tests/test_phase14_runtime_hardening.py tests/test_phase1_contracts.py tests/test_gpfs_backend.py
python3 -m pytest -q
...
다음 항목은 Phase 14까지 완료된 기능으로 보지 않는다.

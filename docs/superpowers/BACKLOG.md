...
갱신: 2026-08-11. 기준: 브랜치 `worktree-dms-slice18-20`(슬라이스 18·19·20 완료,
origin 에 푸시됨). `main` 병합은 사용자 몫으로 남겼다.

---

## 0. 현재 상태

- 슬라이스 1~20 완료. 슬라이스 21 «포탈 빌드 되살리기» 는 설계 전(사용자 요청).
- 테스트베드 이미지: 제어면 `dms:d32`, 에이전트 `dms-agent:d32`,
